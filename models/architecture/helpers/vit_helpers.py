...
def update_default_cfg_and_kwargs(default_cfg, kwargs, kwargs_filter):
    ...
    # Filter keyword args for task specific model variants (some 'features only' modules, etc.)
...
def build_model_with_cfg(
    ...
    This helper fn aids in the construction of a model including:
      ...
      * passing through optional model_cfg for modules with config based arch spec
    ...
    # For classification modules, check class attr, then kwargs, then default to 1k, otherwise 0 for feats
